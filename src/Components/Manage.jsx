        ...
        <>
            <div>
                <div className=' grid gap-2 justify-center items-center text-center py-14'>
                    <p className='text-[#4D4D4D] text-3xl font-semibold '>Manage your entire community <br /> in a single system</p>
                ...
                <div className='flex shadow-md px-6 py-9 flex-col items-center'>
                        ...
                        <h1 className=' text-[#4D4D4D] text-lg font-semibold'>Membership <br /> Organisations</h1>
                    ...
                    <div className='flex shadow-md px-6 py-9 flex-col items-center'>
                        ...
                        <h1 className=' text-[#4D4D4D] text-lg font-semibold'>National  <br /> Associations</h1>
                        <p className=' text-[#717171]'>
                        Our membership management <br />
                        software provides full automation of <br />
                    ...
                    <div className='flex shadow-md px-6 py-9 flex-col items-center'>
                        ...
                        <h1 className=' text-[#4D4D4D] text-lg font-semibold'>Clubs And <br /> Groups</h1>
                        <p className=' text-[#717171]'>
                        Our membership management <br />
                        software provides full automation of <br />
                        membership renewals and payments
